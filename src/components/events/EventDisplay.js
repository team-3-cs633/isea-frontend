    ...
    <div className="event-grid">
      <div className="single-event-grid">
        <span>
          ...
          <b>Favorites:</b> {props.metrics.favorites} - - <b>Shares:</b>{" "}
          {props.metrics.shares}
        </span>
        <span>
          <b>Description</b>: {props.event.description}
        </span>
        <span>
          <b>Category</b>: {props.event.category}
        </span>
        <span>
          <b>Location</b>: {props.event.location}
        </span>
        <span>
          <b>Date</b>: {readableDate(props.event.start_time)} @
          {readableTime(props.event.start_time)} -- <b>to </b>
          -- {readableDate(props.event.end_time)} @
          {readableTime(props.event.end_time)}
        </span>
        <span>
          <b>Cost</b>: {props.event.cost}
        </span>
        <span>
          <b>Link</b>:{" "}
          {props.event.event_link ? (
            <a href={props.event.event_link}>{props.event.event_link}</a>
          ) : (
            "N/A"
          )}
        </span>
        ...
        {shareEnabled && (
          <div>
            ...
            <button
              ...
              onClick={() => handleShareEvent(props.event.id, to)}
            >
              Submit
            </button>
          </div>
